...
struct AppStyles {
    struct TextStyle{
        ...
        static let subtitle = Font.system(size: 28, weight: .semibold)
        static let subsubtitle = Font.system(size: 24, weight: .semibold)
        static let body = Font.system(size: 22, weight: .regular)
        static let secInfos = Font.system(size: 22, weight: .regular)
        static let highlight = Font.system(size: 22, weight: .bold)
